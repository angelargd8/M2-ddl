...
def get_pickle_automata() -> LexicalAutomata:
    with open(
        "C://Users//pablo//OneDrive - UVG//Escritorio//UVG//7mo Semestre//Diseño de lenguajes de Programacion//Modulo 2//Fase de Compilacion//M2-ddl//src//Yalex//generatorAFDS//lexical_out//lexicalAutomata.pkl",
        "rb",
    ) as file:
...
# Guardar resultados
guardar_en_txt(resultados, "Yalex/Out/TokensReadPckl.txt")
print("Resultados guardados en Yalex/Out/TokensReadPckl.txt")
